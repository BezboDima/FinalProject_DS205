...
/**
 * ArrayList implements functions of Actionlistener and InteractiveData. It can
 * be displayed on the Screen and behaves like an ArrayList
 * 
 * @author Dmitry
 *
 */
public class ArrayList implements ActionListener, InteractiveData {

	// ArrayDataStructure Simulator uses custom buttons and label
	private CustomLabel arrayLabel = new CustomLabel();
	private Buttons buttons = new Buttons();
	private JFrame frame = new JFrame("Array List");
